            ...
            @foreach($bu as $b)
                <div class="col-md-4 column productbox">
                    ...
                    <div class="productprice">
                        <div class="pull-left">
                            @if($b->bu_status == 0)
                                <span  class="btn btn-danger btn-sm pull-left" style="margin-right: 35px" role="button">فى انتظار التفعيل <li class="fa fa-minus-circle" style="color: white"></li></span>
                                <a href="{{ route('user.building.edit', $b->id) }}" class="btn btn-primary btn-sm pull-right" role="button">تعديل العقار <li class="fa fa-minus-circle" style="color: white"></li></a>

                                <div class="clearfix"></div>
                                <hr>
                            @else
                            <a href="{{ route('single.building', $b->id) }}" class="btn btn-primary btn-sm" role="button"> اعرض التفاصيل <li class="fa fa-minus-circle" style="color: white"></li></a>
                            @endif
