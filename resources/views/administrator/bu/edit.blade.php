...
@section('content')
    <hr>
    <h2>تعديل العقار {{ $bu->name_name }}</h2>
    <hr>
    ...
    <div class="form-group">
        ...
        <br>
        <img src="{{ checkImage($bu->image , '/buImages/') }}" alt="" width="200" height="100">
        <br>
        <br>
    ...
    <div class="group">
        <input type="submit" value="تعديل العقار" class="btn btn-warning">
    </div>
    <br>
    {!! Form::close() !!}
@stop
